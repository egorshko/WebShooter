...
public class ThrowingStickman : MonoBehaviour
{
	...
	{
		HipsRigidbody.transform.Rotate(RotationVector);
	}
	private void OnCollisionEnter(Collision collision)
	{
		...
		if (collision.gameObject.CompareTag("Web"))
		{
			...
			HipsRigidbody.AddForce(ThrowingVector);
		}
	...
	public void TrowObjectUp()
	{
		...
		HipsRigidbody.AddForce(Vector3.up * _throwingForce);
	}
